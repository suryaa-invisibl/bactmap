...
process ALIGNPSEUDOGENOMES {
    ...
    do
        fraction_non_GATC_bases=\$(python3 $projectDir/bin/calculate_fraction_of_non_GATC_bases.py -f \$pseudogenome | tr -d '\\n')
    ...
    python3 $projectDir/bin/reference2single_sequence.py -r ${reference} -o final_reference.fas
